...
Welcome to your new DLL mod, you should see you now have a `CarbonTemplateGUI.sln` file, all the files you see here were generated from the template.

## Usage

1. Clone this repository locally
2. Open the `CarbonTemplateGUI.sln` file in Visual Studio
